...
try:
    ...
    while(1):
        ...
        outFile_accel.write("{:d},{:7.3f},{:7.3f},{:7.3f}, {:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f},{:7.3f}\n".format(callibrate_count, imu.gx, imu.gy, imu.gz,imu.ax, imu.ay, imu.az, imu.mx, imu.my, imu.mz))  
